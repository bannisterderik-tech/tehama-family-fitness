...
export const classes = [
  { slug: "spin", hero: "spin", name: "Spin", page: true, room: "Spin Room",
  ...
  { slug: "yoga", hero: "yoga", name: "Yoga", page: true, room: "Yoga/Pilates/Dance Studio",
  ...
  { slug: "barre", hero: "barre", name: "Barre Above", page: true, room: "Studio",
  ...
  { slug: "zumba", hero: "studio", name: "Zumba & Tone", page: true, room: "Studio",
  ...
  { slug: "pilates", hero: "yoga", name: "Mat Pilates", page: true, room: "Studio",
  ...
  { slug: "tai-chi", hero: "studio", name: "Tai Chi", page: true, room: "Studio",
